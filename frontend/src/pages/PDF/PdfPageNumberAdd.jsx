...
const PdfPageNumberAdd = () => {
    ...
    return (
        <div className='mt-[72px] dark:bg-[#0f172a]'>
            ...
            <p className='text-center text-gray-500 my-5'>Easily add page numbers to pdf documents online for free.</p>
            ...
            <div className='w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] mx-auto flex flex-col justify-center items-center gap-5'>
                <button className='mx-auto bg-[#1A8FE3] px-6 py-3 text-white rounded-lg' onClick={() => document.querySelector('input[type="file"]').click()}>Choose File</button>
                {
                    ...
                    <>
                        ...
                        <select
                            className='border-2 border-[#1A8FE3] rounded-lg p-2'
                            value={position}
                        ...
                        <button className='mx-auto bg-[#1A8FE3] px-6 py-3 text-white rounded-lg' onClick={addPageNumber}>Add Page Number & Download</button>
                    </>
                }
            </div>
            <FreeTools />
