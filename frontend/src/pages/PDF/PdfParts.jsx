...
const PdfParts = () => {
    ...
    return (
        <div className='mt-[72px] dark:bg-[#0f172a]'>
            ...
            <p className='text-center text-gray-500 my-5'>Easily make pdf parts online for free.</p>
                ...
                <button className='mx-auto bg-[#1A8FE3] px-6 py-3 text-white rounded-lg' onClick={() => document.querySelector('input[type="file"]').click()}>Choose File</button>
                {
                    ...
                    <>
                        ...
                        <input
                            ...
                            className='w-[25%] border-2 border-[#1A8FE3] p-2 rounded-lg'
                        />
                        <button className='mx-auto bg-[#1A8FE3] px-6 py-3 text-white rounded-lg' onClick={splitPDF}>Make Parts</button>
                    </>
                }
            </div>
            <FreeTools />
