  ...
  const DraggableItem = ({ item, index, moveItem, ItemType }) => {
    ...
    return (
      <div
        ...
        className="px-4 mb-2 bg-gray-200 border-lightBlue border-dashed border-2 rounded w-full h-[40px] flex gap-2 justify-start items-center cursor-move"
      >
        <FiMenu size={20} />
    ...
    <div className="mt-[72px] dark:bg-darkBlue">
      ...
      <div className="flex justify-center flex-wrap items-center gap-5 mt-5">
        <button
          ...
          className={`${
            !Object.keys(pagesList)?.length > 0 ? "bg-gray600" : "bg-lightBlue"
