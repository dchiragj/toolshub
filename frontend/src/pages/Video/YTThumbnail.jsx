...
const YTThumbnail = () => {
    ...
    return (
        <div className='mt-[72px] dark:bg-[#0f172a]'>
            ...
            <p className='text-center text-gray-500 my-5'>Easily download thumbnails from youtube online for free.</p>
            ...
            <div className='flex justify-center items-center gap-10 mt-5'>
                <button disabled={!url} className={`px-5 py-2 ${!url ? "bg-gray-500" : "bg-[#1A8FE3] hover:bg-white hover:text-[#1A8FE3]"} text-white rounded-lg flex justify-center items-center gap-2`} onClick={getFromLink}>
                    Get Thumbnail
                </button>
            </div>
            {
                ...
                <div className='my-5 flex flex-col justify-center items-center gap-5'>
                    ...
                    <button className='px-5 py-2 bg-[#1A8FE3] text-white rounded-lg' onClick={download}>Download Thumbnail</button>
                </div>
            }
            <FreeTools />
            <WebTools />
