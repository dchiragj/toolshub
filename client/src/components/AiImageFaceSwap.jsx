    ...
    <>
      <div className="mt-[72px] dark:bg-darkBlue">
        ...
        <div className="w-[90%] sm:w-[80%] mx-auto flex flex-wrap justify-start items-center gap-5">
          <div className="w-full md:w-[calc(50%_-_10px)] relative h-[400px]">
            <div className="w-full h-[calc(100%_-_48px)] border-2 flex justify-center items-center border-lightBlue">
              <div className="flex w-full h-full flex-col items-center justify-center">
                {image1 ? (
                  ...
                  <div className="flex flex-col justify-center items-center gap-2">
                    ...
                    <p className="text-gray400 text-[18px]">
                      Upload Source Image
                    </p>
                  </div>
                )}
            ...
            <div className="w-full absolute bottom-0">
              ...
              />
              <button
                className="bg-lightBlue flex justify-center items-center h-[48px] text-white w-full"
          ...
          <div className="w-full md:w-[calc(50%_-_10px)] relative h-[400px]">
            <div className="w-full h-[calc(100%_-_48px)] border-2 border-lightBlue flex justify-center items-center">
              <div className="flex w-full h-full flex-col items-center justify-center">
                {image2 ? (
                  <img
                    src={image2}
