    ...
    return (
        <div className='mt-[72px] dark:bg-[#0f172a]'>
            ...
            <div className='flex justify-center items-center mt-5'>
                <button className={`px-5 py-2 ${!description ? "bg-gray-500" : "bg-[#1A8FE3]"} text-white rounded-lg`} disabled={!description} onClick={generateKeywords}>Generate Keywords</button>
            </div>
            {
                keywords.length > 0 &&
