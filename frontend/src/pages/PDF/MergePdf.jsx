...
const MergePdf = () => {
    ...
    return (
        <div className='mt-[72px] dark:bg-[#0f172a]'>
            ...
            <p className='text-center text-gray-500 my-5'>Easily merge pdf documents with text files online for free.</p>
            ...
            <div className='w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] mx-auto flex flex-col justify-center items-center gap-5'>
                ...
                {files.length > 0 && (
                    <div className='w-full flex flex-col justify-center items-center gap-5'>
                        ...
                        <button className='mx-auto bg-[#1A8FE3] px-6 py-3 text-white rounded-lg' onClick={mergePdfs}>Merge PDFs</button>
                        {<button className={`mx-auto ${!mergedPdf ? "bg-gray-500" : "bg-[#1A8FE3]"} px-6 py-3 text-white rounded-lg`} disabled={!mergedPdf} onClick={handleDownload}>Download</button>}
                    </div>
                )}
            </div>
            <FreeTools />
