...
const AnyImageToSVG = () => {
    ...
    return (
        <div className='mt-[72px] dark:bg-[#0f172a]'>
            ...
            <p className='text-center text-gray-500 my-5'>Easily convert image to SVG online for free</p>
            ...
            {imgURL && !convertedImageUrl && !svgContent && <div className='flex justify-center items-center mt-5'>
                <button className='bg-[#1A8FE3] px-6 py-3 text-white rounded-lg' onClick={convertSVG}>Convert To SVG</button>
            </div>}
            <div className={`${imgURL ? "bg-transparent" : "bg-white"} w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] ${imgURL ? "h-auto" : "h-[500px]"} mx-auto mt-10 ${imgURL ? "border-none" : "border shadow-custom"} border-gray-200`}>
                {imgURL && !convertedImageUrl && !svgContent && <img src={imgURL} alt={'svg'} className='mx-auto' />}
                {
                    ...
                    <div className='flex flex-col justify-center items-center gap-5'>
                        ...
                        <button className='bg-[#1A8FE3] px-6 py-3 text-white rounded-lg' onClick={handleDownloadSVG}>Download SVG FILE</button>
                    </div>
                }
            </div>
            <FreeTools />
