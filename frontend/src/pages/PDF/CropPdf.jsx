...
const PdfCropper = () => {
    ...
    return (
        <div className="mt-[72px] dark:bg-[#0f172a]">
            ...
            <p className='text-center text-gray-500 my-5'>Easily crop PDF pages online for free</p>
            ...
            </div>
            {
                ...
                <div className='flex flex-col justify-center items-center gap-5 mt-5'>
                    <div className='flex justify-center items-center gap-5 flex-wrap'>
                        <button className={`${currentPageIndex === 0 ? "bg-gray-500" : "bg-[#1A8FE3]"} text-white py-2 px-5 rounded-lg`} onClick={prevPage} disabled={currentPageIndex === 0}>
                            Previous
                        </button>
                        <button className={`${currentPageIndex === pdfPages.length - 1 ? "bg-gray-500" : "bg-[#1A8FE3]"} text-white py-2 px-5 rounded-lg`} onClick={nextPage} disabled={currentPageIndex === pdfPages.length - 1}>
                            Next
                        </button>
                    </div>
                    <button className={`${!cropperInstances.some(c => c) ? "bg-gray-500" : "bg-[#1A8FE3]"} text-white py-2 px-5 rounded-lg`} onClick={downloadCroppedPdf} disabled={!cropperInstances.some(c => c)}>
