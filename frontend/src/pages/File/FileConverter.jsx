...
const FileConverter = () => {
    ...
    return (
        <div className='mt-[72px] dark:bg-[#0f172a]'>
            ...
            <p className='text-center text-gray-500 my-5'>Easily generate all formats file online for free.</p>
            ...
            <div className='w-[90%] sm:w-[80%] mx-auto'>
                ...
                <textarea
                    ...
                    className='w-full border-2 border-[#1A8FE3] p-2 rounded-lg outline-none'
                    value={text}
            ...
            }
            {
                ...
                <div className='flex flex-col mt-5 justify-center items-center gap-5'>
                    ...
                    {
                        converted ?
                            <button className={`mx-auto bg-[#1A8FE3] px-6 py-3 text-white rounded-lg`} onClick={handleDownload}>Download File</button> :
                            <button className={`${(!file && !text) || !format ? "bg-gray-500" : "bg-[#1A8FE3]"} mx-auto px-6 py-3 text-white rounded-lg`} disabled={(!file && !text) || !format} onClick={handleGenerateDownload}>Generate & Download File</button>
                    }
                </div>
            }
            <FreeTools />
