    ...
    return (
        <div className='mt-[72px] dark:bg-[#0f172a]'>
            ...
            <div className='w-[90%] sm:w-[80%] mx-auto flex flex-col justify-center items-center gap-5'>
                ...
                <button className='bg-[#1A8FE3] px-6 py-3 text-white rounded-lg' onClick={() => document.querySelector('input[type="file"]').click()}>Choose File</button>
                ...
                }
                {
                    title !== 'Small Text Generator' ?
                        <button className={`${!text ? "bg-gray-500" : "bg-[#1A8FE3]"} px-6 py-3 text-white rounded-lg`} disabled={!text} onClick={convert}>Apply</button>
                        :
                        <div className='flex justify-center items-center gap-5'>
                            <button className={`${!text ? "bg-gray-500" : "bg-[#1A8FE3]"} px-6 py-3 text-white rounded-lg`} disabled={!text} onClick={() => scriptConvert('superScript')}>Convert to SuperScript</button>
                            <button className={`${!text ? "bg-gray-500" : "bg-[#1A8FE3]"} px-6 py-3 text-white rounded-lg`} disabled={!text} onClick={() => scriptConvert('subScript')}>Convert to Subscript</button>
                        </div>
                }
                {
                    ...
                    <>
                        ...
                        <div className='flex justify-center items-center gap-5'>
                            <CopyToClipboard text={convertedText} onCopy={() => setCopyText(true)}>
                                <button className={`bg-[#1A8FE3] px-6 py-3 text-white rounded-lg`}>Copy</button>
                            </CopyToClipboard>
                            <button className={`bg-[#1A8FE3] px-6 py-3 text-white rounded-lg`} onClick={handleReset}>Reset</button>
                        </div>
                    </>
                }
                {
                    ...
                    <>
                        <table className='border-2  border-gray-500' cellPadding={'1px'}>
                            <thead>
                                <th>Metric</th>
                                <th>Value</th>
                            </thead>
