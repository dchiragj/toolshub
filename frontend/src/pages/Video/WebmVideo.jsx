...
const WebmVideo = () => {
    ...
    return (
        <div className='mt-[72px] dark:bg-[#0f172a]'>
            ...
            <p className='text-center text-gray-500 my-5'>Easily convert web cam to webm online for free.</p>
            <div className='sm:mx-10 flex flex-col gap-5'>
                ...
                <div className='flex justify-center items-center gap-5'>
                    {
                        !isRecording ? <button className='px-5 py-2 text-white bg-[#1A8FE3] hover:bg-white hover:text-[#1A8FE3] rounded-lg' onClick={startRecording}>Start Recording</button>
                            : <button className='px-5 py-2 text-white bg-[#1A8FE3] hover:bg-white hover:text-[#1A8FE3] rounded-lg' onClick={stopRecording}>Stop Recording</button>
                    }
                </div>
                {videoURL &&
                    <div className='flex flex-col gap-5'>
                        <video src={videoURL} controls className='w-full h-[500px]'></video>
                        <button className='px-5 py-2 text-white bg-[#1A8FE3] hover:bg-white hover:text-[#1A8FE3] rounded-lg' onClick={downloadVideo}>Download</button>
                    </div>
                }
            </div>
            <Ads slot='' className="mx-10 mt-5" />
