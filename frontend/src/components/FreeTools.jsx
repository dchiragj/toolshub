...
const FreeTools = () => {
    ...
    return (
        <>
            <div className='mx-10 rounded-3xl py-10 dark:bg-[#0f172a]'>
                <div className='flex flex-col'>
                    <div className='flex flex-col text-center mb-10'>
                        ...
                        <p className='text-xs sm:text-sm md:text-base lg:text-lg  text-gray-500'>No Limits, No Sign-Up, Here's our featured tools</p>
                    </div>
                    <Swiper
                        slidesPerView={1}
                        spaceBetween={10}
                    ...
                    >
                        {
                            cards.map((val, ind) => {
                                return (
                                    <SwiperSlide key={ind} className='rounded-2xl shadow-xl border border-gray-200 dark:bg-[#1a252e]'>
                                        <NavLink to={val.link} className='flex flex-col p-3 dark:bg-[#1a252e] rounded-2xl'>
                                            ...
                                            <div className='flex flex-col text-left mt-5'>
                                                ...
                                                <p className='text-base sm:text-lg text-gray-500 pt-2'>{val.description}</p>
                                            </div>
                                        </NavLink>
                                    </SwiperSlide>
                                )
