...
END:VCARD`;
    ...
    return (
        <div className='mt-[72px] dark:bg-[#0f172a]'>
            ...
            <p className='text-center text-gray-500 my-5'>Easily generate premium QR codes online for free.</p>
            <div className='flex flex-wrap justify-center items-center gap-5 dark:text-white mt-10'>
                {
                    qrProperty.map((val, ind) => {
                        return (
                            <button key={ind} className={`flex justify-center items-center gap-2 border px-4 py-2 dark:border-gray-500 rounded ${val.tabs === tabs ? "bg-[#1A8FE3] text-white border-[#1A8FE3] dark:border-[#1A8FE3]" : ""}`} onClick={() => changeProperty(val.tabs, val.text)}>
                                {val.icon}{val.text}
                            </button>
                        )
                    })
            ...
            <div className='grid grid-cols-1 xl:grid-cols-2 gap-5 my-10 mx-10 sm:mx-20 md:mx-28 bg-[aliceblue] dark:bg-[#0f172a] p-5 rounded-2xl dark:border-gray-500 dark:border'>
                    ...
                    <div className='w-[90%] mx-auto flex flex-col justify-center items-center gap-5'>
                        {
                            ...
                            <input
                                ...
                                className='w-full mx-auto border-2 outline-none border-[#1A8FE3] p-2 px-5 rounded-full text-black dark:text-white dark:bg-[#0f172a] dark:border-white'
                                value={url}
                        ...
                        }
                        {
                            ...
                            <textarea
                                ...
                                className='w-full mx-auto border-2 outline-none border-[#1A8FE3] p-2 px-5 rounded-lg text-black dark:text-white dark:bg-[#0f172a] dark:border-white'
                                value={text}
                                rows={5}
                        ...
                        }
                        {
                            ...
                            <>
                                ...
                                />
                                <select
                                    className='w-full mx-auto border-2 outline-none border-[#1A8FE3] p-2 px-5 rounded-full dark:text-white dark:bg-[#0f172a] dark:border-white'
                                    name='cornerSquare'
                                    value={skypeAction}
                    ...
                    <Accordion expanded={expanded === 'panel3'} onChange={() => handleChange('panel3')} sx={{ borderRadius: "12px !important", backgroundColor: darkMode ? "#1a252e" : "white", color: darkMode ? "white" : "" }} className="bg-black">
                        ...
                        <AccordionDetails>
                            <div className='flex flex-col justify-center items-center gap-5'>
                                ...
                                <select
                                    className='w-full border py-2 rounded-lg border-gray-400 dark:bg-[#0f172a] px-1'
                                    name='cornerSquare'
                            ...
                            qrValue ?
                                <div className='flex flex-col justify-center items-center gap-5'>
                                    ...
                                    <div className='flex justify-center items-center gap-5'>
                                        <button className='bg-[#1A8FE3] text-white rounded-lg  px-4 py-2' onClick={downloadQRCode}>Download QR</button>
                                        <button className='bg-[#1A8FE3] text-white rounded-lg  px-4 py-2' onClick={reGenerateQRCode}>Reset</button>
                                    </div>
                                </div>
                                :
                                <div className='flex flex-col justify-center items-center gap-5'>
                                    <img src={sampleQR} alt="Sample QR" />
                                    <button className={`${btnDisabled ? "bg-gray-500" : "bg-[#1A8FE3]"} text-white rounded-lg  px-4 py-2`} disabled={btnDisabled} onClick={generateQRCode}>Generate QR</button>
                                </div>
                        }
                    </div>
                </div>
