...
const ColorTextToPdf = () => {
    ...
    return (
        <div className='mt-[72px] dark:bg-[#0f172a]'>
            ...
            <p className='text-center text-gray-500 my-5'>Easily generate colored text pdf documents online.</p>
            <div className='w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] mx-auto flex flex-col justify-center items-center gap-5'>
                ...
                <div className='flex justify-center items-center gap-5'>
                    <div className='flex flex-col justify-center items-center gap-2'>
                        ...
                        <select
                            className='w-full dark:text-white border py-2 rounded-lg border-gray-400 dark:bg-[#0f172a] px-1 outline-none'
                            name='fontSize'
                ...
                <div className='flex justify-center items-center gap-5'>
                    <button className={`px-5 py-2 ${!text ? "bg-gray-500" : "bg-[#1A8FE3]"} text-white rounded-lg`} disabled={!text} onClick={applyStyle}>Apply Styles</button>
                    <button className={`px-5 py-2 ${!text ? "bg-gray-500" : "bg-[#1A8FE3]"} text-white rounded-lg`} disabled={!text} onClick={convert}>Generate PDF</button>
                </div>
                {
                    pdfUrl &&
                    <div className='flex justify-center items-center gap-5'>
                        <button className={`px-5 py-2 bg-[#1A8FE3] text-white rounded-lg`} onClick={handleDownload}>Download PDF</button>
                        <button className={`px-5 py-2 bg-[#1A8FE3] text-white rounded-lg`} onClick={handleReset}>Reset</button>
                    </div>
                }
            </div>
            {
