    ...
    return (
        <div className='mt-[72px] dark:bg-[#0f172a]'>
            ...
            <div className='w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] mx-auto flex flex-col justify-center items-center gap-5'>
                ...
                ></input>
                <button className={`px-5 py-2 ${!page1Url || !page2Url ? "bg-gray-500" : "bg-[#1A8FE3]"} text-white rounded-lg`} disabled={!page1Url || !page2Url} onClick={convert}>Generate HTACCESS Redirect</button>
            </div>
            {
                redirectURL &&
