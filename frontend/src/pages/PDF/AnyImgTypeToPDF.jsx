...
const ToPDF = ({ type }) => {
    ...
    return (
        <div className='mt-[72px] dark:bg-[#0f172a]'>
            ...
            <p className='text-center text-gray-500 my-5'>Convert <span className='uppercase'>{type}</span> to {heading || 'PDF'} online for free</p>
            ...
            <div className={`bg-white w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] ${typeURL ? "h-auto" : "h-[500px]"} mx-auto mt-10 ${typeURL ? "border-none" : "border shadow-custom"} border-gray-200`}>
            ...
            </div>
            {
                ...
                <>
                    ...
                    <div className='flex justify-center items-center mt-5'>
                        <button className=' mx-auto bg-[#1A8FE3] px-6 py-3 text-white rounded-lg' onClick={generatePDF}>Convert To PDF & Download</button>
                    </div>
                </>
            }
            <FreeTools />
