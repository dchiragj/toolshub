...
const Home = () => {
    ...
    return (
        <div className='dark:bg-[#0f172a] mt-[72px]'>
            ...
            <div className='dark:bg-[#0f172a] dark:text-white p-5 px-2'>
            ...
            <div className='rounded-xl shadow-custom grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-5 sm:m-10  p-10 px-10 sm:px-12 xl:px-20'>
                {
                    FeaturedCard.map((val, ind) => {
                        return (
                            <div key={ind} className="flex flex-col">
                                ...
                                <div className='p-5 py-3 dark:border-gray-400 dark:bg-[#0f172a] border border-t-0 rounded-b-xl border-gray-200 text-xs'>
                                    <div className='flex justify-between items-center p-5 py-3 rounded-lg' style={{ backgroundColor: val.bottomBgColor }}>
                                        <p>Other Featured : </p>
                                        <NavLink to={val.otherLink} className="text-[#1A8FE3] text-xs font-medium px-2 rounded-full hover:underline decoration-[#1A8FE3]">{val.otherText}</NavLink>
                                    </div>
                                </div>
                            </div>
                        )
