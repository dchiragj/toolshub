...
const PdfToAnyText = ({ from, to }) => {
    ...
    return (
        <div className='mt-[72px] dark:bg-[#0f172a]'>
            ...
            <p className='text-center text-gray-500 my-5'>Convert {from.toUpperCase()} to {to.toUpperCase()} online for free</p>
            ...
            <div className='w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] mx-auto flex flex-col justify-center items-center gap-5'>
                ...
                <button className={`mx-auto ${!file ? "bg-gray-500" : "bg-[#1A8FE3]"} px-6 py-3 text-white rounded-lg`} disabled={!file} onClick={convert}>Convert to {to.toUpperCase()}</button>
            </div>
            ...
            </div>
            {
                ...
                <div className='w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] mx-auto flex flex-col justify-center items-center gap-5'>
                    ...
                    <textarea
                        ...
                        readOnly
                    ></textarea>
                    <button className='mx-auto bg-[#1A8FE3] px-6 py-3 text-white rounded-lg' onClick={handleDownload}>Download</button>
                </div>
