...
const Header = ({ expandSidebar, setExpandSidebar }) => {
  ...
  return (
    <>
      <div className="p-4 shadow-lg h-[72px] bg-white dark:bg-[#0f172a] w-full fixed top-0 left-0 z-2000">
        <div className="flex justify-between item-center">
          ...
          <nav className="gap-8 text-lg hidden lg:flex dark:text-white">
            <li className="relative flex items-center gap-2 rounded-lg px-2 hover:bg-[aliceblue] dark:hover:bg-[#1a252e] delay-150 group cursor-pointer">
              <p className="hover:text-[#1A8FE3]">{t('pdf')}</p>
            ...
            <li className="flex items-center gap-2 rounded-lg px-2 hover:bg-[aliceblue] dark:hover:bg-[#1a252e] delay-150 group cursor-pointer hover:text">
              <p className="hover:text-[#1A8FE3]">{t('image')}</p>
              <IoIosArrowDown className="text-gray-500" />
              <ImageMenu />
            </li>
            <li className="flex items-center gap-2 rounded-lg px-2 hover:bg-[aliceblue] dark:hover:bg-[#1a252e] delay-150 group cursor-pointer">
              <p className="hover:text-[#1A8FE3]">{t('text')}</p>
              <IoIosArrowDown className="text-gray-500" />
              <TextMenu />
            </li>
            <li className="flex items-center gap-2 rounded-lg px-2 hover:bg-[aliceblue] dark:hover:bg-[#1a252e] delay-150 group cursor-pointer">
              <p className="hover:text-[#1A8FE3]">{t('other')}</p>
              <IoIosArrowDown className="text-gray-500" />
              <OtherMenu />
            </li>
            <li className="flex items-center gap-2 rounded-lg px-2 hover:bg-[aliceblue] dark:hover:bg-[#1a252e] delay-150 group cursor-pointer">
              <p className="hover:text-[#1A8FE3]">{t('file')}</p>
              <IoIosArrowDown className="text-gray-500" />
              <FileMenu />
            </li>
          </nav>
          <div className="flex items-center">
            <div className="flex gap-3 border-r-0 md:border-r-2 md:px-4 border-r-gray-400">
              <div
                className="p-2 rounded-full shadow-2xl border border-gray-400 cursor-pointer bg-transparent dark:text-white dark:hover:text-black hover:bg-yellow-200 hover:border-yellow-200"
              ...
              <div className="p-2 rounded-full shadow-2xl border border-gray-400 cursor-pointer bg-transparent dark:text-white dark:hover:text-black hover:bg-yellow-200 hover:border-yellow-200" onClick={shareHandle} title="Share">
