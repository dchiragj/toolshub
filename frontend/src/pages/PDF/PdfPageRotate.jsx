...
const PdfPageRotate = () => {
    ...
    return (
        <div className='mt-[72px] dark:bg-[#0f172a]'>
            ...
            <p className='text-center text-gray-500 my-5'>Easily rotate pdf page online for free.</p>
            ...
            <div className='w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] mx-auto flex flex-col justify-center items-center gap-5'>
                        ...
                        pageImages.map((page, index) => (
                            <div className='flex flex-col justify-center items-center' key={page.pageIndex}>
                                ...
                                <div className='flex justify-center items-center gap-5 flex-wrap'>
                                    <button className='bg-#6f56ec p-2 text-white rounded-lg' onClick={() => rotatePage(page.pageIndex, 'left')}>Rotate Left</button>
                                    <button className='bg-#6f56ec p-2 text-white rounded-lg' onClick={() => rotatePage(page.pageIndex, 'right')}>Rotate Right</button>
                                </div>
                            </div>
                        ))
                    }
                ...
                {
                    pageImages.length > 0 &&
                    <button className='bg-[#1A8FE3] px-6 py-3 text-white rounded-lg' onClick={downloadRotatedPDF}>Download Rotated PDF</button>
                }
            </div>
            <FreeTools />
            <WebTools />
