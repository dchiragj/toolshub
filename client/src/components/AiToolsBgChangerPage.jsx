        ...
        <div className="w-[90%] sm:w-[80%] mx-auto flex flex-col justify-center items-center gap-5">
          ...
          {Object.keys(file)?.length > 0 && (
            <div className="mt-10 flex justify-center items-center flex-col gap-3">
              ...
              <select
                className="w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] mx-auto border-2 outline-none border-lightBlue p-2 px-5 rounded-full dark:text-white dark:bg-darkBlue dark:border-white"
                name="background"
                onChange={(e) => {
